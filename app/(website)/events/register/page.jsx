...
const Register = () => {
  ...
  const [formActive] = useState(false); // For deactivating the form
  const [temporaryActive] = useState(true); // For displaying the temporary message

  return (
    <div
      className="flex justify-center min-h-screen items-center bg-gradient-to-b from-[#197fbd] from-10% via-[#5abeea] via-30% to-[#ffffff]"
      style={{
    ...
    >
      ...
      {temporaryActive && (
        <div className="flex flex-col justify-center items-center">
          <Navbar />
          <PiSmileySadLight size={96} />
          <h3 className="text-xl lg:text-4xl py-2 font-semibold text-center bg-gradient-to-br from-purple-600 via-pink-600 to-blue-600 inline-block text-transparent bg-clip-text">
            The event registration is temporarily closed.
          </h3>
          <p>!!It will Open Soon!!</p>
        </div>
      )}
      {/* Render the form based on formActive */}
      {formActive && (
              ...
              <div>
                <div>
                  <h2 className="font-semibold text-center border-2 p-1 rounded-lg shadow-md bg-blue-300 my-2">
                    Event Registraion Fee &#8377;300 for 4 events.. &#8377;100
